package com.microservice.example.planservice.controller;
...
import com.microservice.example.planservice.service.PlanService;

@RestController
@RequestMapping("plan-service")
public class PlanController {
	...
	public String sayHello() {
		return "Hi There from Plan-service !!";
	}
